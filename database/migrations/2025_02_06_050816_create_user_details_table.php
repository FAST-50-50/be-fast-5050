...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('user_details', function (Blueprint $table) {
            ...
            $table->integer('birth_year')->nullable()->comment('Year of birth for team division considerations');
            $table->string('whatsapp_number', 20)->nullable()->comment('WhatsApp number for communication');
            $table->string('instagram_handle', 100)->nullable()->comment('Instagram handle to check if they follow fast5050bandung');
            $table->text('telu_relation')->nullable()->comment('Relationship with Telkom University');
            $table->integer('joined_since')->nullable()->comment('Year they started playing with FAST 50:50');
            ...
            $table->text('benefit')->nullable()->comment('Skills & contributions they can offer to FAST 50:50');
            $table->text('suggestion')->nullable()->comment('Skills & contributions they can offer to FAST 50:50');
            $table->timestamps();
        });
    }
